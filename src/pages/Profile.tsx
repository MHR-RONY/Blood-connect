		...
		<div className="min-h-screen bg-medical/20">
			...
			{isLoading ? (
				<div className="container mx-auto px-4 py-8">
					<BloodLoading message="Loading profile" />
				</div>
			) : !user ? (
				<div className="container mx-auto px-4 py-8">
							...
							<TabsContent value="donations" className="space-y-6">
								<Card>
									...
									<CardContent>
										<div className="space-y-4">
											{loadingDonations ? (
												<BloodLoading size="sm" message="Loading donation history" />
												...
												donationHistory.map((donation) => (
													<div key={donation.id} className="flex items-center justify-between p-4 border border-border rounded-lg">
														<div className="flex items-center space-x-4">
															<div className={`p-2 rounded-full ${donation.type === 'Available Donor Registration'
